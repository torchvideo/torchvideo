...
def test_segment_sampler_with_fewer_frames_than_segments():
...
def test_segment_sampler_with_average_segment_frame_count_less_than_1():
    segment_count = 3
...
def test_segment_sampler_with_average_segment_frame_count_greater_than_1():
    segment_count = 3
    sampler = TemporalSegmentSampler(segment_count, 1)
    frame_count = 6
...
def test_segment_sampler_index_properties(segment_count, segment_length, video_length):
...
def test_segment_count_should_be_greater_than_0():
    with pytest.raises(ValueError):
